...
typedef struct ALNcol
{
  ...
  unsigned int homoplasy_child;
  unsigned int homoplasy_parent;
  unsigned int homoplasy_both;
  unsigned int whomoplasy;
  unsigned int whomoplasy_max;
  double whomoplasy_avg;
  unsigned int whomoplasy_sum;
  unsigned int whomoplasy_child;
  unsigned int whomoplasy_parent;
  unsigned int whomoplasy_both;
  unsigned int whomoplasy2;
  unsigned int whomoplasy2_max_min;
  unsigned int whomoplasy2_max_max;
  unsigned int whomoplasy2_min_max;
  double whomoplasy2_avg_min;
  double whomoplasy2_avg_max;
  double whomoplasy2_avg_avg;
  unsigned int whomoplasy2_sum;
  unsigned int whomoplasy2_sum_max;
  double whomoplasy2_sum_avg;
  unsigned int whomoplasy2_minchild;  
  unsigned int whomoplasy2_maxchild;
  unsigned int whomoplasy2_gapchild;
  unsigned int whomoplasy2_reschild;
  unsigned int whomoplasy2_minparent;
  unsigned int whomoplasy2_maxparent;
  unsigned int whomoplasy2_gapparent;
  unsigned int whomoplasy2_resparent;
  unsigned int whomoplasy2_gapsum;
